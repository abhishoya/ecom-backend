...
import com.github.loki4j.client.http.*;
...
public class SecurityConfig
{
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeRequests()
                .requestMatchers("/api/payment/swagger/**","/api/payment/recordPayment").permitAll()
    ...
    public class AuthFilter extends OncePerRequestFilter
    {
        ...
        protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
            return request.getRequestURI().matches("/api/payment/swagger/(.*)") || request.getRequestURI().matches("/api/payment/recordPayment");
        }
    }
}
